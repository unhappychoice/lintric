// Generated tests for TypeScript node types
...
fn test_generated_literal_type() {
    let source_code = r#"const value13: 'hello' = 'hello';"#;
...
fn test_generated_lookup_type() {
    let source_code = r#"type Obj = { key: string }; const value14: Obj['key'] = 'test';"#;
...
fn test_generated_object() {
    let source_code = r#"{ prop11: value16, prop2: value21 }"#;
...
fn test_generated_object_assignment_pattern() {
    let source_code = r#"const { prop3 = defaultVal } = obj2;"#;
...
fn test_generated_object_pattern() {
    let source_code = r#"const { prop12, prop21 } = object;"#;
...
fn test_generated_object_type() {
    let source_code = r#"const value17: { prop4: number } = { prop4: 42 };"#;
...
fn test_generated_pair_pattern() {
    let source_code = r#"const { key1: value18 } = obj3;"#;
...
fn test_generated_parenthesized_type() {
    let source_code = r#"const value20: (string | number) = 'test';"#;
...
fn test_generated_predefined_type() {
    let source_code = r#"const value22: string = 'test';"#;
...
fn test_generated_readonly_type() {
    let source_code = r#"const value23: readonly number[] = [1, 2, 3];"#;
...
fn test_generated_return_statement() {
    let source_code = r#"function test() { return value24; }"#;
...
fn test_generated_satisfies_expression() {
    let source_code = r#"value25 satisfies string"#;
...
fn test_generated_switch_statement() {
    let source_code = r#"switch (value26) { case 1: break; default: break; }"#;
...
fn test_generated_template_literal_type() {
    let source_code =
        r#"type Test<T3> = `hello ${T3}!`; const value27: Test<'world'> = 'hello world!';"#;
...
fn test_generated_template_type() {
    let source_code = r#"const value28: `hello ${string}` = 'hello world';"#;
...
fn test_generated_tuple_type() {
    let source_code = r#"const value29: [string, number] = ['hello', 42];"#;
...
fn test_generated_union_type() {
    let source_code = r#"const value31: string | number = 'test';"#;
...
fn test_generated_with_statement() {
    let source_code = r#"with (obj4) { prop5; }"#;
...
fn test_generated_yield_expression() {
    let source_code = r#"yield value32"#;
...
fn test_generated_object1() {
    let source_code = r#"{ prop13: value110, prop22: value210 }"#;
...
fn test_generated_shorthand_property_identifier_pattern() {
    let source_code = r#"const { prop6 } = obj5;"#;
