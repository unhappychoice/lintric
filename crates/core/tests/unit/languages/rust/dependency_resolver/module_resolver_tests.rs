...
mod integration_tests {
    ...
    fn test_complex_visibility_rules() {
        ...
        let mut definition_visibility = std::collections::HashMap::new();
        definition_visibility.insert(format!("{}:pub_super_item", child_module), Visibility::PubSuper);
        
        let visibility_checker = VisibilityChecker::new(module_tree, definition_visibility);
        
        let definition = Definition {
            name: "pub_super_item".to_string(),
            position: Position { start_line: 1, start_column: 1, end_line: 1, end_column: 14 },
            definition_type: DefinitionType::FunctionDefinition,
        };
    ...
    fn test_cross_module_field_access() {
        ...
        let struct_def = Definition {
            ...
            position: Position { start_line: 1, start_column: 1, end_line: 5, end_column: 1 },
            definition_type: DefinitionType::StructDefinition,
        };
        ...
        let import = ImportInfo {
            ...
            visibility: Visibility::Private,
            position: Position { start_line: 1, start_column: 1, end_line: 1, end_column: 20 },
        };
        
        module_tree.add_import(main_module, import);
        
        // Verify cross-module access
        assert!(module_tree.modules[&structs_module].exports.contains_key("PublicStruct"));
    ...
    fn test_module_re_exports() {
        ...
        let core_function = Definition {
            ...
            position: Position { start_line: 10, start_column: 1, end_line: 12, end_column: 1 },
            definition_type: DefinitionType::FunctionDefinition,
        };
        
        module_tree.add_export(core_module, "core_function".to_string(), core_function.clone());
        ...
        let import = ImportInfo {
            ...
            position: Position { start_line: 1, start_column: 1, end_line: 1, end_column: 25 },
        };
        ...
        assert!(module_tree.modules[&core_module].exports.contains_key("core_function"));
        assert!(module_tree.modules[&lib_module].exports.contains_key("core_function"));
    }
    ...
    fn test_wildcard_imports() {
        ...
        let wildcard_import = ImportInfo {
            ...
            visibility: Visibility::Private,
            position: Position { start_line: 1, start_column: 1, end_line: 1, end_column: 15 },
        };
    ...
    fn test_use_statement_resolution() {
        ...
        let models_module = module_tree.add_module("models".to_string(), Some(database_module), None);
        
        // Add some exports to models
        let user_model = Definition {
            name: "User".to_string(),
            position: Position { start_line: 1, start_column: 1, end_line: 10, end_column: 1 },
            definition_type: DefinitionType::StructDefinition,
        };
        ...
        assert_eq!(module_tree.find_module_by_path("database"), Some(database_module));
        assert_eq!(module_tree.find_module_by_path("database::models"), Some(models_module));
        assert!(module_tree.modules[&models_module].exports.contains_key("User"));
