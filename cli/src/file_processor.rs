...
pub fn process_directory(path: &Path, base_path: Option<&Path>) -> Result<Vec<AnalysisResult>, String> {
...
pub fn process_path(path_str: &str) -> (Vec<AnalysisResult>, f64, usize) {
    ...
    (all_results, total_overall_complexity_score, total_files_analyzed)
}
